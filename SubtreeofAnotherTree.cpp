...
Success
Details 
Runtime: 36 ms, faster than 87.06% of C++ online submissions for Subtree of Another Tree.
Memory Usage: 29.3 MB, less than 66.49% of C++ online submissions for Subtree of Another Tree.
*/
