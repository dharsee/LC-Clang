...
fall equally to the glass immediately to the left and right of it.  When those glasses become full, any excess champagne will fall 
equally to the left and right of those glasses, and so on.  (A glass at the bottom row has its excess champagne fall on the floor.)
...
on the second row are half full.  After three cups of champagne are poured, those two cups become full - there are 3 full glasses total now.  
...
public:
    double champagneTower(int poured, int query_row, int query_glass) {
        ...
        // Since at max we can have 100 rows
        // lets create a 101 X 101 MAtrix and try till fill the valuse by looking at the poured 
        ...
        /*
                    Success
            Details 
            Runtime: 20 ms, faster than 32.34% of C++ online submissions for Champagne Tower.
            Memory Usage: 43.8 MB, less than 5.11% of C++ online submissions for Champagne Tower.
        */
